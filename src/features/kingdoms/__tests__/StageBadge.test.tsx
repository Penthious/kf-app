...
describe('StageBadge', () => {
    it('renders locked stage correctly', () => {
        const { getByText, getByTestId } = render(
            <StageBadge stage={0} testID="stage-badge" />
        );
    ...
    it('applies correct styling for stage 1', () => {
        const { getByTestId } = render(
            <StageBadge stage={1} testID="stage-badge" />
        );
    ...
    it('applies correct styling for stage 2', () => {
        const { getByTestId } = render(
            <StageBadge stage={2} testID="stage-badge" />
        );
    ...
    it('applies correct styling for stage 3', () => {
        const { getByTestId } = render(
            <StageBadge stage={3} testID="stage-badge" />
        );
    ...
    it('applies correct styling for stage 4', () => {
        const { getByTestId } = render(
            <StageBadge stage={4} testID="stage-badge" />
        );
