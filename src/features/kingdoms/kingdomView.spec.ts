...
describe('buildKingdomView', () => {
    ...
    it('correctly determines completed status for single attempt adventures', () => {
        ...
        const result = buildKingdomView('test-kingdom', campaignWithSingleAttempt, [mockKingdomCatalog]);
    ...
    it('always sets completed to false for non-single attempt adventures', () => {
        ...
        const result = buildKingdomView('test-kingdom', campaignWithMultipleAttempts, [mockKingdomCatalog]);
    ...
    it('handles undefined kingdom state', () => {
        ...
        const result = buildKingdomView('test-kingdom', campaignWithUndefinedState, [mockKingdomCatalog]);
