...
describe('ChoiceMatrixCard', () => {
  ...
  it('renders the component with title', () => {
    const { getByText } = render(<ChoiceMatrixCard knightUID='knight-1' />);
  ...
  it('handles knight with no choiceMatrix', () => {
    const { getByText } = render(<ChoiceMatrixCard knightUID='knight-2' />);
  ...
  it('handles non-existent knight', () => {
    const { getByText } = render(<ChoiceMatrixCard knightUID='non-existent' />);
