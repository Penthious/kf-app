...
describe('KnightNameSection', () => {
  ...
  it('renders with name input', () => {
    const { getByTestId, getByText } = render(
      <KnightNameSection name='Test Knight' setName={mockSetName} testID='name-section' />
    );
  ...
  it('displays the provided name', () => {
    const { getByTestId } = render(
      <KnightNameSection name='Sir Galahad' setName={mockSetName} testID='name-section' />
    );
  ...
  it('calls setName when text changes', () => {
    const { getByTestId } = render(
      <KnightNameSection name='' setName={mockSetName} testID='name-section' />
    );
  ...
  it('renders without testID when not provided', () => {
    const { queryByTestId } = render(
      <KnightNameSection name='Test Knight' setName={mockSetName} />
    );
