...
describe('AllySection', () => {
  ...
  it('renders the section title', () => {
    const { getByText } = render(
      <AllySection title='Saints' allies={[]} onAdd={mockOnAdd} onRemove={mockOnRemove} />
    );
  ...
  it('handles empty title', () => {
    const { getByText } = render(
      <AllySection title='' allies={[]} onAdd={mockOnAdd} onRemove={mockOnRemove} />
    );
