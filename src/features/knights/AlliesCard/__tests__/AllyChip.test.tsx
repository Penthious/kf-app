...
describe('AllyChip', () => {
    ...
    it('renders the ally label', () => {
        const { getByText } = render(
            <AllyChip label="Saint George" onRemove={mockOnRemove} />
        );
    ...
    it('handles long ally names', () => {
        ...
        const { getByText } = render(
            <AllyChip label={longName} onRemove={mockOnRemove} />
        );
    ...
    it('handles special characters in ally names', () => {
        ...
        const { getByText } = render(
            <AllyChip label={specialName} onRemove={mockOnRemove} />
        );
    ...
    it('handles empty label', () => {
        const { getByText } = render(
            <AllyChip label="" onRemove={mockOnRemove} />
        );
