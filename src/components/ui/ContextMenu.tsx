...
export function measureInWindow(ref: React.RefObject<{ measureInWindow?: (callback: (x: number, y: number, w: number, h: number) => void) => void }>): Promise<LayoutRectangle | null> {
