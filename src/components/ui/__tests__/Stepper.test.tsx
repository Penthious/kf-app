...
describe('Stepper', () => {
    it('renders with default value', () => {
        ...
        const { getByTestId } = render(
            <Stepper value={5} onChange={mockOnChange} testID="stepper" />
        );
    ...
    it('displays the current value', () => {
        const mockOnChange = jest.fn();
        const { getByTestId } = render(
            <Stepper value={10} onChange={mockOnChange} testID="stepper" />
        );
    ...
    it('clamps input values to min/max range', () => {
        const mockOnChange = jest.fn();
        const { getByTestId } = render(
            <Stepper value={5} onChange={mockOnChange} min={0} max={10} editable={true} testID="stepper" />
        );
    ...
    it('uses custom parse function when provided', () => {
        ...
        const { getByTestId } = render(
            <Stepper value={5} onChange={mockOnChange} parseValue={parseValue} editable={true} testID="stepper" />
        );
    ...
    it('renders without testID when not provided', () => {
        ...
        const { queryByTestId } = render(
            <Stepper value={5} onChange={mockOnChange} />
        );
    ...
    it('handles zero value', () => {
        const mockOnChange = jest.fn();
        const { getByTestId } = render(
            <Stepper value={0} onChange={mockOnChange} testID="stepper" />
        );
