...
describe('Pill', () => {
  it('renders with label', () => {
    const { getByText } = render(<Pill label='Test Pill' />);
  ...
  it('calls onPress when pressed', () => {
    ...
    const { getByText } = render(<Pill label='Test Pill' onPress={mockOnPress} />);
  ...
  it('renders with accent tone styling', () => {
    const { getByTestId } = render(<Pill label='Test Pill' tone='accent' testID='test-pill' />);

    expect(getByTestId('test-pill')).toBeTruthy();
  });

  it('renders with success tone styling', () => {
    const { getByTestId } = render(<Pill label='Test Pill' tone='success' testID='test-pill' />);

    expect(getByTestId('test-pill')).toBeTruthy();
  });

  it('renders with danger tone styling', () => {
    const { getByTestId } = render(<Pill label='Test Pill' tone='danger' testID='test-pill' />);

    expect(getByTestId('test-pill')).toBeTruthy();
  });

  it('applies selected styling when selected', () => {
    const { getByTestId } = render(<Pill label='Test Pill' selected={true} testID='test-pill' />);
  ...
  it('applies disabled styling when disabled', () => {
    const { getByTestId } = render(<Pill label='Test Pill' disabled={true} testID='test-pill' />);
  ...
  it('renders without testID when not provided', () => {
    const { queryByTestId } = render(<Pill label='Test Pill' />);

    expect(queryByTestId('test-pill')).toBeNull();
  });

  it('handles empty label', () => {
    const { getByTestId } = render(<Pill label='' testID='test-pill' />);
  ...
  it('handles long label text', () => {
    ...
    const { getByTestId } = render(<Pill label={longLabel} testID='test-pill' />);
