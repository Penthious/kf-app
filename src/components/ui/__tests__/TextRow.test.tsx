...
describe('TextRow', () => {
  it('renders with label and input', () => {
    ...
    const { getByText, getByTestId } = render(
      <TextRow label='Test Label' value='' onChangeText={mockOnChangeText} testID='text-row' />
    );
  ...
  it('displays the provided value', () => {
    ...
    const { getByDisplayValue } = render(
      <TextRow label='Test Label' value='test value' onChangeText={mockOnChangeText} />
    );
  ...
  it('renders without testID when not provided', () => {
    ...
    const { queryByTestId } = render(
      <TextRow label='Test Label' value='' onChangeText={mockOnChangeText} />
    );
