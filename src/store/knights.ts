...
export type KnightsActions = {
    ...
    updateKnightSheet: (knightUID: string, patch: Partial<Knight['sheet']>) => { ok: boolean; error?: string };

    // Investigation actions
    completeQuest: (knightUID: string, chapter: number, outcome?: InvestigationResult) => { ok: boolean; error?: string };
    addNormalInvestigation: (knightUID: string, chapter: number, invId: string, result: InvestigationResult) => { ok: boolean; error?: string };
    addLeadCompletion: (knightUID: string, chapter: number, invId: string) => { ok: boolean; error?: string };
