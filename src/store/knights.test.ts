...
function minimalKnightInput(overrides?: Partial<Parameters<typeof useKnights.getState> extends never
    ? never
    : Omit<ReturnType<typeof defaultSheet>, 'version' | 'updatedAt'>> & any) {
