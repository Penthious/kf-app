...
export const ThemeProvider: React.FC<React.PropsWithChildren> = ({children}) => {
  ...
  const [systemPref, setSystemPref] = useState<'light' | 'dark'>(Appearance.getColorScheme() === 'light' ? 'light' : 'dark');
  ...
  // persist on change
  useEffect(() => { AsyncStorage.setItem(STORAGE_KEYS.MODE, mode); }, [mode]);
  useEffect(() => {
